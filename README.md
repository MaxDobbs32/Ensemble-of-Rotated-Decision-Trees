...
Random forests, a kind of ensemble of decision trees with a random component, have demonstrated themselves to be quite useful in drawing boundaries that effectively categorize data. However, the boundaries they give are difficult to interpret. In this project, I create and test ensembles of rotated decision trees, built in Python, hoping that they might make more interpretable boundaries without losing accuracy. These ensembles are compared with random forests in their ability to categorize data from three data sets: the 2019 CPS ORG uniform extracts, the inventory of owned and leased properties, and the national student loan data system. (See more information in ensemble_code_and_tests.ipynb and citations below.)
